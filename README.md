...
- [(TEST FILE) Broken Access Control](tests/test_broken_access_control.py)
  - [(EXTERNAL) CWE-22 Improper Limitation of a Pathname to a Restricted Directory ('Path Traversal')](https://cwe.mitre.org/data/definitions/22.html)
  - [(EXTERNAL) CWE-23 Relative Path Traversal](https://cwe.mitre.org/data/definitions/23.html)
  - [(EXTERNAL) CWE-285 Improper Authorization](https://cwe.mitre.org/data/definitions/285.html)
- [(TEST FILE) Serverside Request Forgery (SSRF)](tests/test_ssrf.py)
  - [(EXTERNAL) CWE-918 Server-Side Request Forgery (SSRF)](https://cwe.mitre.org/data/definitions/918.html)
